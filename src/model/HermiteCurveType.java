...
public class HermiteCurveType extends CurveType {
	...
	public Point evalCurveAt(List controlPoints, double t) {
		ControlPoint r1 = new ControlPoint((((ControlPoint)controlPoints.get(1)).getCenter().getX() - ((ControlPoint)controlPoints.get(0)).getCenter().getX()),
				(((ControlPoint)controlPoints.get(1)).getCenter().getY() - ((ControlPoint)controlPoints.get(0)).getCenter().getY()));
		ControlPoint r2 = new ControlPoint((((ControlPoint)controlPoints.get(3)).getCenter().getX() - ((ControlPoint)controlPoints.get(2)).getCenter().getX()),
				(((ControlPoint)controlPoints.get(3)).getCenter().getY() - ((ControlPoint)controlPoints.get(2)).getCenter().getY()));
		...
		System.out.println("Point 4  (" + ((ControlPoint)controlPoints.get(3)).getCenter().getX()+","+((ControlPoint)controlPoints.get(3)).getCenter().getY()+")");
